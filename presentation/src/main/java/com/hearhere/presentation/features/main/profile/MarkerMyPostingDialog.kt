...
class MarkerMyPostingDialog : BottomSheetDialogFragment() {
    ...
    private val viewModel: MarkerMyPostingViewModel by activityViewModels()
    ...
    companion object {
        fun newInstance(postId: Long, title: String): MarkerMyPostingDialog {
            val fragment = MarkerMyPostingDialog()
            val POST_ID = "postId"
            val TITLE = "title"
